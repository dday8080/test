...
let welcome = "Welcome to the challenge round for testing of javascript ";
let welcome2 = "on planet Earth.";
let planetaryWelcome = welcome + welcome2;

element.innerHTML += planetaryWelcome;
...
/* didn't work properly needed filter.
    let word = 'This is great   tEsties 1  ';
    word = word.toLowerCase()
...
let strs = ['pro', 'prototype', 'proficient'];
